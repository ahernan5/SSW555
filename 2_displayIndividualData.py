#  Parses Dictionary Data to Output All Individual Data
    ...
    for id in idListSorted:
        ...
        if (birthdate != 'N/A'):
            ...
            birthday = birthdateSplit[2] + '-' + \
                monthToNumDict[birthdateSplit[1]] + \
                '-' + birthdateSplit[0].zfill(2)
        ...
        if (deathdate != 'N/A'):
            ...
            death = deathdateSplit[2] + '-' + \
                monthToNumDict[deathdateSplit[1]] + '-' + deathdateSplit[0]
            indiData['DEAT'] = death
        else:
            indiData['ALIVE'] = 'True'
            alive = 'True'
...
def main(fileName, GEDCOM_dict):
    ...
    if (fileName.endswith('_dict.json')):
        ...
        individualDataTable = displayIndividualData(
            GEDCOM_dict['individualData'])
        ...
        # Overwrite GEDCOM Created in 2_storeDataAsDict.py with Data Matching Tables
